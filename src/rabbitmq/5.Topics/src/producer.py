...
class RabbitMQProducer:
    ...
    tls_enable = to_boolean(os.getenv("TLS_ENABLE", True))
    ...
    def publish(self, msg: dict):
        ...
        self.disconnect()
        print(f"[x] Sent '{msg}' message to '{self.exchange}' exchange on '{self.routing_key}' routing_key.")
